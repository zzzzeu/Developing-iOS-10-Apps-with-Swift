...
class PlayingCardView: UIView {
    ...
    var faceCardScale: CGFloat = SizeRatio.faceCardImageSizeBoundsSize {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    private func confiureCornerLabel(_ label: UILabel) {
    ...
    override func layoutSubviews() {
        ...
        confiureCornerLabel(upperLeftCornerLabel)
        upperLeftCornerLabel.frame.origin = bounds.origin.offsetBy(dx: cornerOffset, dy: cornerOffset)
        
        confiureCornerLabel(lowerRightCornerLabel)
...
extension PlayingCardView {
    private struct SizeRatio {
        ...
        static let faceCardImageSizeBoundsSize: CGFloat = 0.75
    }
